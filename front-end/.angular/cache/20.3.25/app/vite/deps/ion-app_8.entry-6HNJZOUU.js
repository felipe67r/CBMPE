...
} from "./chunk-MU5AAQ52.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-CYGZWT7M.js";
import "./chunk-G7X3SCEJ.js";
import {
  isRTL
} from "./chunk-5XC3XI4B.js";
import {
  createLockController
} from "./chunk-BQOAERP7.js";
import "./chunk-I3INT2RF.js";
import {
  getTimeGivenProgression
} from "./chunk-UQVP7ZKI.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-VMZ56ZVI.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-SQNHEUBS.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-ZCK26YJQ.js";
import {
  shouldUseCloseWatcher
} from "./chunk-E4RXQEXP.js";
import {
  transition
} from "./chunk-GHN2FB5L.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-YTXVX5T6.js";
import "./chunk-3QRLT7WG.js";
import {
  Host,
  config,
  createEvent,
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-JKJCDMUD.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-M6GJAYOG.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-MR7L7HPH.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-L6Q2XVB3.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-VKYNTXJB.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-PJZGWELP.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-ERM3OK5R.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
//# sourceMappingURL=ion-app_8.entry-6HNJZOUU.js.map
